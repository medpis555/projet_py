...
def start_fun():
    ...
    def open_file():
        ...
        ("Text Files", "*.txt"), ("Html Files", "*.html"), ("Python Files", "*.py"), ("Word Files", "*.doc"),
        ("All Files", "*.*")))
    ...
    def save_as_file():
        text_file = filedialog.asksaveasfilename(defaultextension=".*", initialdir="C:/gui/", title="Save File",
                                                 filetypes=(("Text Files", "*.txt"), ("HTML Files", "*.html"),
                                                            ("Python Files", "*.py"), ("Word Files", "*.doc"),
    ...
    my_text = Text(my_frame, width=97, height=25, font=("Helvetica", 16), selectbackground="yellow",
                   ...
                   xscrollcommand=hor_scroll.set, fg="black", bg="light yellow", borderwidth=4,relief="solid")
    my_text.pack()
    ...
    editButton = Button(my_frame, text="Find and Replace", font=("Arial", 13),  bd=0, command=openFindReplaceDialog, bg = "#1b1b1b", fg = "white", borderwidth=6, relief="sunken"
                        ,width=30,height=10,activebackground="#1b1b1b")
    editButton.pack(side=RIGHT, padx=10, pady=10)

    uploadButton = Button(my_frame, text="Selectionner file", font=("Arial", 13), fg = "white", bd=4,
                          command=open_pdf, bg = "#1b1b1b",  borderwidth=3, relief="sunken",activebackground="#1b1b1b")
    uploadButton.pack(side=LEFT, padx=10, pady=10)

    lireButton = Button(my_frame, text="lire en voix", font=("Arial", 13),   bg = "#1b1b1b", fg = "white", borderwidth=3, relief="raised", bd=2, activebackground="#1b1b1b",
                        command=talk)
    lireButton.pack(side=LEFT, padx=10, pady=10)

    regxButton = Button(my_frame, text="regex", font=("Arial", 13),   bg = "#1b1b1b", fg = "white", borderwidth=3 ,activebackground="#1b1b1b", relief="raised", command=regx)
    regxButton.pack(side=LEFT, padx=10, pady=10)
    regxButton = Button(my_frame, text="verifier email", font=("Arial", 13),
                        command=email, bg = "#1b1b1b", fg = "white", borderwidth=3, relief="raised" ,activebackground="#1b1b1b")
    regxButton.pack(side=LEFT, padx=10, pady=10)
    ...
    # create color
    color_text_btn = Button(toolbar_frame, text="Text Couleur", command=text_color)
    color_text_btn.grid(row=0, column=4, padx=5)



# top label
start1 = Label(text = "BIENVENUS ", font=("Arial", 55,"underline"), bg="white",fg="black", borderwidth=3) # same way bg
start1.place(x = 440, y = 20)

# created start button
startb = Button(root, text="START",command=start_fun,font=("Arial", 25), bg = "black", fg = "white", bd=5, relief="sunken",activebackground="#1b1b1b")
startb.place(x = 450, y =650 )
...
def exit_win():
    if mbox.askokcancel("Exit", "etes vous sur de vouloire quitter?"):
        root.destroy()

# created exit button
exitb = Button(root, text="Annuler",command=exit_win,font=("Arial", 25), bg = "black", fg = "white", bd=5, relief="sunken",activebackground="#1b1b1b")
